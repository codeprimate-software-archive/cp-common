/*
 * MergeSortTest.java (c) 24 October 2004
 *
...
import com.cp.common.util.sort.MergeSort;
import java.util.Comparator;
import junit.framework.Test;
import junit.framework.TestSuite;

public class MergeSortTest extends com.cp.common.util.sort.AbstractSortTest {

  private static final int NUMERIC_LIST_SIZE = 10000;

  public MergeSortTest(final String testName) {
    super(testName);
  }
  ...
  public static Test suite() {
    ...
    //suite.addTest(new MergeSortTest("testName"));
    return suite;
  }
