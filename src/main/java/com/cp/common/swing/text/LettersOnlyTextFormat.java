/*
 * LettersOnlyTextFormat.java (c) 12 October 2002
 *
...
public final class LettersOnlyTextFormat implements TextFormat {
  ...
  private static final Logger logger = Logger.getLogger(LettersOnlyTextFormat.class);
  ...
  public String format(final Document doc, final int offset, final String text) throws InvalidTextFormatException {
    ...
    if (!StringUtil.isLettersOnly(text)) {
      logger.warn("The text must consist of only letters a through z and/or A through Z!");
