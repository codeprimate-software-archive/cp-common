/*
 * DigitsOnlyTextFormat.java (c) 20 July 2002
 *
...
public final class DigitsOnlyTextFormat implements TextFormat {
  ...
  private static final Logger logger = Logger.getLogger(DigitsOnlyTextFormat.class);
  ...
  public String format(final Document doc, final int offset, final String text) throws InvalidTextFormatException {
    ...
    if (!StringUtil.isDigitsOnly(text)) {
      logger.warn("The text must only consist of digits 0 through 9.");
